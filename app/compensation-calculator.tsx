...
export default function CompensationCalculator({ onAssistantModuleChange }: { onAssistantModuleChange?: (module: "compensation" | "sales") => void }) {
